...
class DriveStep(object):
    ...
    def __init__(self, pos=(0,0), unit_length=0.35):
    ...
    def drive_forwards_advanced(self): 
        ...
        if self.skew != None:
            ...
            if self.skew[2] == 90:
                ...
                sideskew = 0
            angle_correction = self.max_turn_speed*2/(1+math.exp(5*self.skew[1])) - self.max_turn_speed
            drift_correction = self.max_turn_speed*2/(1+math.exp(-15*sideskew)) - self.max_turn_speed
